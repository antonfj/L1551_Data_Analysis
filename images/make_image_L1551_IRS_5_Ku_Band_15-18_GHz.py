...
image = 'L1551_IRS5_Ku_Band_VLA_15-18_GHz_r_+0.5.fits'
image_mJy = 'L1551_IRS5_Ku_Band_VLA_15-18_GHz_r_+0.5.mJy.fits'

final_image = 'L1551_IRS_5_Ku_Band_15-18_GHz.pdf'
...
fig.show_colorscale(vmin=-2e-2, vmax=7e-1, cmap='jet')
