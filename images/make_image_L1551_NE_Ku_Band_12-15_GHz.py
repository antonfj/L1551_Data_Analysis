...
image = 'L1551_NE_Ku_Band_VLA_12-15_GHz_r_+0.5.fits'
image_mJy = 'L1551_NE_Ku_Band_VLA_12-15_GHz_r_+0.5.mJy.fits'

final_image = 'L1551_NE_Ku_Band_12-15_GHz.pdf'
...
fig.show_colorscale(vmin=-2e-2, vmax=3.5e-1, cmap='jet')
