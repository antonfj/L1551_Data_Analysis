...
image = 'L1551_IRS5_K_Band_VLA_18-22_GHz_r_+0.5.fits'
image_mJy = 'L1551_IRS5_K_Band_VLA_18-22_GHz_r_+0.5.mJy.fits'

final_image = 'L1551_IRS_5_K_Band_18-22_GHz.pdf'
...
fig.show_colorscale(vmin=-3e-2, vmax=8e-1, cmap='jet')
