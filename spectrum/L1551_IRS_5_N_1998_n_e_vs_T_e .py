...
theta_values = np.arange(0.1, 0.5, 0.01)
print(theta_values)
...
# Set axes
plt.axis([0.0, 50000.0, 0.0, 7e5])

plt.tight_layout()				# Make everything fit in window
plt.savefig('L1551_IRS_5_N_1998_ff_spec_fit_n_e vs_T_e.png')
...
plt.tight_layout()				# Make everything fit in window
plt.savefig('L1551_IRS_5_N_1998_ff_spec_fit_n_e vs_theta.png')
plt.show()
