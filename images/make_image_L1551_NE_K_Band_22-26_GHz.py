...
image = 'L1551_NE_K_Band_VLA_22-26_GHz_r_+0.5.fits'
image_mJy = 'L1551_NE_K_Band_VLA_22-26_GHz_r_+0.5.mJy.fits'

final_image = 'L1551_NE_K_Band_22-26_GHz.pdf'
...
fig.show_colorscale(vmin=-3e-2, vmax=4e-1, cmap='jet')
