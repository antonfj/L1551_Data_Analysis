...
npix = "400"            # Size of image in pixels
...
X_Band_image.writeFits(fname="L1551_IRS_5_C_Band_5_GHz_simulated_conical_mlr_1e-9_z0_10au_zmax_120au_res_0.5au_grid_0.5au_no_conv.fits", dpc=140,coord="04h31m34.17s+18d08m04.28s")
# Convolve beam of e-MERLIN C Band image
#X_Band_image = X_Band_image.imConv(dpc=140.,psfType='gauss',fwhm=[0.20,0.18],pa=-49.0)
X_Band_image = X_Band_image.imConv(dpc=140.,psfType='gauss',fwhm=[0.22,0.11],pa=44.0)
...
X_Band_image.writeFits(fname="L1551_IRS_5_C_Band_5_GHz_simulated_conical_mlr_1e-9_z0_10au_zmax_120au_res_0.5au_grid_0.5au.fits", dpc=140,coord="04h31m34.17s+18d08m04.28s",
#                       bandwidthmhz=500.0, casa=False,stokes="I")
#X_Band_image.writeFits(fname="L1551_IRS_5_C_Band_5_GHz_simulated_test.fits", dpc=140,coord="04h31m34.17s+18d08m04.28s",
                       bandwidthmhz=500.0, casa=False,stokes="I")
"""
