...
plt.errorbar(log_freq, log_flux, yerr=log_flux_err, fmt='bo', label='2017 - 2021', markersize=markersize)
# Plot 2003 data
plt.errorbar(log_freq_2003, log_flux_2003, yerr=log_flux_err_2003, fmt='gs', label='2002', markersize=markersize)
# Plot 1998 data
plt.errorbar(log_freq_1998, log_flux_1998, yerr=log_flux_err_1998, fmt='r^', label='1985 - 1997', markersize=markersize)
