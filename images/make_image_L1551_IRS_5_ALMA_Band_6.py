...
image = 'L1551_IRS_5_ALMA_Band_6_shifted.fits'
image_mJy = 'L1551_IRS_5_ALMA_Band_6_shifted.mJy.fits'

final_image = 'L1551_IRS_5_ALMA_Band_6.pdf'
...
fig.show_colorscale(vmin=-3, vmax=130, cmap='jet')
...
sigma=0.75
fig.show_contour(image_mJy, levels=[-3*sigma, 3*sigma, 4*sigma, 6*sigma,
    8*sigma,10*sigma, 12*sigma, 25*sigma, 50*sigma, 75*sigma,
