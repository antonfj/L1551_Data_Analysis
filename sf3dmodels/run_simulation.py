...
mass_loss_rate=5.7e-9     # Mass loss rate of star in M_sun yr^-1
...
frequency = 6e9        # Frequency to simulate image
...
C_Band_image.writeFits(fname="L1551_IRS_5_C_Band_5_GHz_simulated_conical_mlr_5.7e-9_z0_10au_zmax_120au_res_0.25au_grid_0.25au_coarse_no_conv.fits", dpc=140,coord="04h31m34.17s+18d08m04.28s")
# Convolve beam of e-MERLIN C Band image
#X_Band_image = X_Band_image.imConv(dpc=140.,psfType='gauss',fwhm=[0.20,0.18],pa=-49.0)
C_Band_image = C_Band_image.imConv(dpc=140.,psfType='gauss',fwhm=[0.22,0.11],pa=44.0)
...
C_Band_image.writeFits(fname="L1551_IRS_5_C_Band_5_GHz_simulated_conical_mlr_5.7e-9_z0_10au_zmax_120au_res_0.25au_grid_0.25au_coarse.fits", 
                       dpc=140,coord="04h31m34.17s+18d08m04.28s", bandwidthmhz=500.0, casa=False,stokes="I")
"""
t0 = time.time()

num_threads = "24"      # Set num. of threads for RADMC-3D to use

# Image at X Band (10 GHz)
frequency = 10e9        # Frequency to simulate image
sizeau = "270"          # Size in au of area to image
npix = "40"            # Size of image in pixels

# Image at C Band (5 GHz)
radmc3d_command = ["radmc3d", "image", "lambda", "30000", "setthreads", num_threads, "sizeau", sizeau, "npix", npix, "stokes"]
subprocess.run(radmc3d_command, shell=False, check=True, universal_newlines=True)
#makeImage(wav=60000.,sizeau=sizeau,npix=npix)
...
X_Band_image = readImage("image.out")
X_Band_image.writeFits(fname="L1551_IRS_5_X_Band_10_GHz_simulated_conical_mlr_5.7e-9_z0_10au_zmax_120au_res_0.25au_grid_0.25au_coarse_no_conv.fits", dpc=140,coord="04h31m34.17s+18d08m04.28s")
# Convolve beam of X Band image
X_Band_image = X_Band_image.imConv(dpc=140.,psfType='gauss',fwhm=[0.20,0.18],pa=-49.0)
#plotImage(C_Band_image,log=False,cmap=cm.hot,bunit='jy/beam',dpc=140,au=False,arcsec=True)
X_Band_image.writeFits(fname="L1551_IRS_5_X_Band_10_GHz_simulated_conical_mlr_5.7e-9_z0_10au_zmax_120au_res_0.25au_grid_0.25au_coarse.fits",
                       dpc=140,coord="04h31m34.17s+18d08m04.28s", bandwidthmhz=500.0, casa=False,stokes="I")
